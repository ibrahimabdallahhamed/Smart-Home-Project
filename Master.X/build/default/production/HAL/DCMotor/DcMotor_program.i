...
# 76 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_interface.h"
typedef enum {
...
# 117 "HAL/DCMotor/../../MCAL/CCP/CCP.h"
    u32 PWM_FREQ;
    u8 Postscaler;
    u8 Prescaler;
...
# 140 "HAL/DCMotor/../../MCAL/CCP/CCP.h"
...
# 55 "HAL/DCMotor/../../MCAL/TIMER2/TIMER2.h"
typedef struct {
    u8 prescaler;
    u8 postscaler;
    u8 preload;
...
void DCMOTOR_voidDcMotorInt(DcMotor_T *Copy_stDcMotor)
{
    ...
    {
    case 0:
        DC_MotorCCP.ccp_select = 0;
        (CCP1CONbits.CCP1M = 12);

        break;
    case 1:
        (CCP2CONbits.CCP2M = 12);
        DC_MotorCCP.ccp_select = 1;
