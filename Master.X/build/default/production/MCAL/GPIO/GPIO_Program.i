...
# 2 "<built-in>" 2
# 1 "MCAL/GPIO/GPIO_Program.c" 2
# 1 "MCAL/GPIO/../../LIB/STDTYPES.h" 1
# 11 "MCAL/GPIO/../../LIB/STDTYPES.h"
...
# 1 "MCAL/GPIO/../../LIB/BITMATH.h" 1
# 2 "MCAL/GPIO/GPIO_Program.c" 2
...
# 3 "MCAL/GPIO/GPIO_Program.c" 2

# 1 "MCAL/GPIO/../../LIB/pic18f4620.h" 1
# 4 "MCAL/GPIO/GPIO_Program.c" 2
...
void GPIO_VoidSetPortDirection(u8 Copy_u8Port, u8 Copy_u8Direction) {
    ...
    *tris_registers[Copy_u8Port] = Copy_u8Direction;

}

void GPIO_VoidSetPortMode(u8 Copy_u8Port, u8 Copy_u8Mode) {
    *lat_registers[Copy_u8Port] = Copy_u8Mode;
}
...
void GPIO_VoidSetPinDirection(u8 Copy_u8Port, u8 Copy_u8Pin, u8 Copy_u8Direction) {
    ...
    switch (Copy_u8Direction) {
        case 1:
            (*tris_registers[Copy_u8Port] |= (1<<Copy_u8Pin));
            break;
        case 0:
            (*tris_registers[Copy_u8Port] &= ~(1<<Copy_u8Pin));
...
u8 GPIO_u8ReadPin(u8 Copy_u8Port, u8 Copy_u8Pin) {
    ...
    Localu8Returned = ((*port_registers[Copy_u8Port] >>Copy_u8Pin) &1);
...
void GPIO_VoidSetPinMode(u8 Copy_u8Port, u8 Copy_u8Pin, u8 Copy_u8Mode) {
    switch (Copy_u8Mode) {
        case 1:
            (*lat_registers[Copy_u8Port] |= (1<<Copy_u8Pin));
            break;
        case 0:
            (*lat_registers[Copy_u8Port] &= ~(1<<Copy_u8Pin));
