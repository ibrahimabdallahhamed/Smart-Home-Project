# 1 "MCAL/Interrupt/Interrupt_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL/Interrupt/Interrupt_interface.c" 2

# 1 "MCAL/Interrupt/Interrupt_interface.h" 1
# 12 "MCAL/Interrupt/Interrupt_interface.h"
...
# 12 "MCAL/Interrupt/Interrupt_interface.h" 2
# 76 "MCAL/Interrupt/Interrupt_interface.h"
typedef enum {
...
# 2 "MCAL/Interrupt/Interrupt_interface.c" 2
...
void Interrupt_GLOP_InterruptEnable(void) {
# 28 "MCAL/Interrupt/Interrupt_interface.c"
    (RCONbits.IPEN = 0);
    (INTCONbits.GIE=1);
