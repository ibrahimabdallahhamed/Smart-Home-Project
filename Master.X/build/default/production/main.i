...
KeyPad_T KeyPad_1 = {
    .RowPinConfig[0].Port = 1,
    .RowPinConfig[0].Pin = 0,
    .RowPinConfig[1].Port = 1,
    .RowPinConfig[1].Pin = 1,
    .RowPinConfig[2].Port = 1,
    .RowPinConfig[2].Pin = 2,
    .RowPinConfig[3].Port = 1,
    .RowPinConfig[3].Pin = 3,
    .CoulmPinConfig[0].Port = 1,
    .CoulmPinConfig[0].Pin = 4,
    .CoulmPinConfig[1].Port = 1,
    .CoulmPinConfig[1].Pin = 5,
    .CoulmPinConfig[2].Port = 1,
    .CoulmPinConfig[2].Pin = 6,
    .CoulmPinConfig[3].Port = 1,
    .CoulmPinConfig[3].Pin = 7};
...
# 54 "main.c"
    if (EEPROM_u8Read(0x0100) == 0XFF)
    {
        ...
        KeyPadNumber = APP_Get_Number(2, 1);

        Set_Password = KeyPadNumber;
        EEPROM_voidWrite(0x0200, Set_Password >> 8);
        EEPROM_voidWrite(0x0201, (u8) Set_Password);
        EEPROM_voidWrite(0x0100, 0x00);
        _delay((unsigned long)((1000)*(8000000/4000.0)));
        LCD4Bit_voidSendCommand(&LCD_1, 0x01);
    ...
    if (1 == PASSWORD_STATUS) {
        ...
        {(WDTCONbits.SWDTEN = 1); __asm(" clrwdt"); (OSCCONbits.IRCF = 0);};
        while (1) {
            {(WDTCONbits.SWDTEN = 1); __asm(" clrwdt"); (OSCCONbits.IRCF = 0);};
