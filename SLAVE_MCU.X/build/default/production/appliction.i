...
# 11 "./MCAL/GPIO/GPIO_Interface.h"
# 1 "./MCAL/GPIO/GPIO_REG.h" 1
# 11 "./MCAL/GPIO/GPIO_Interface.h" 2
...
# 16 "./HAL/KeyPad/KEYPAD_interface.h"
typedef struct
{
    u8 Port ;
    u8 Pin ;
...
typedef struct
{
 PinConfig RowPinConfig[4];
 PinConfig CoulmPinConfig[4];
}KeyPad_T;

u8 Au8elements[4][4]={{ 7 , 8 , 9 , '/' },
                            { 4 , 5 , 6 , '*' },
                            { 1 , 2 , 3 , '-' },
                            {'c' , 0 , '=' , '+' }};
...
# 1 "./MCAL/ADC/ADC.h" 1
# 12 "./MCAL/ADC/ADC.h"
# 1 "./MCAL/ADC/ADC_config.h" 1
# 12 "./MCAL/ADC/ADC_config.h"
# 1 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\proc\\pic18f4620.h" 1 3
# 12 "./MCAL/ADC/ADC_config.h" 2
# 12 "./MCAL/ADC/ADC.h" 2
# 59 "./MCAL/ADC/ADC.h"
typedef enum {
    ADC_CHANNEL_AN0 = 0,
...
usart_t rc_uart = {
    .BaudRate = 9600,
    .BaudRate_CFG = 0,
    .transmit.usart_tx_9bit_enable = 0,
    .transmit.usart_tx_enable = 0,
    .USART_FramingErrorInterruptHandeler = ((void*)0),
    .USART_OverRunErrorInterruptHandeler = ((void*)0),
    .USART_RxDefualtInterruptHandeler = APP_u8_Bluetooth_Receive,
    .receive.usart_rx_9bit_enable = 0,
    .receive.usart_rx_enable = 1,
    .receive.usart_rx_interrupt_enable = 1};
...
void Application_Init(void)
{
    ...
    GPIO_VoidSetPinDirection(0, 0, 0);
    GPIO_VoidSetPinDirection(0, 1, 0);
    GPIO_VoidSetPortDirection(3, 0);
...
void App_CheckTemp(Data_t *MyData)
{
    ...
    {
        GPIO_VoidSetPinMode(0, 0, 1);
        GPIO_VoidSetPinMode(0, 1, 0);
        LCD4Bit_voidSendString_Pos(&LCD_1, 4, 5, "    ");
        LCD4Bit_voidSendString_Pos(&LCD_1, 4, 5, "ON");
    }
    else
    {
        GPIO_VoidSetPinMode(0, 0, 0);
        GPIO_VoidSetPinMode(0, 1, 0);
