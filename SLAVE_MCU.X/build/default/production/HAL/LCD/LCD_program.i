...
# 2 "<built-in>" 2
# 1 "HAL/LCD/LCD_program.c" 2
# 1 "HAL/LCD/../../LIB/BITMATH.h" 1
# 1 "HAL/LCD/LCD_program.c" 2

# 1 "HAL/LCD/../../LIB/STDTYPES.h" 1
# 11 "HAL/LCD/../../LIB/STDTYPES.h"
...
# 2 "HAL/LCD/LCD_program.c" 2

# 1 "HAL/LCD/../../LIB/device_config.h" 1
# 17 "HAL/LCD/../../LIB/device_config.h"
...
# 3 "HAL/LCD/LCD_program.c" 2

# 1 "HAL/LCD/../../MCAL/GPIO/GPIO_Interface.h" 1
# 11 "HAL/LCD/../../MCAL/GPIO/GPIO_Interface.h"
# 1 "HAL/LCD/../../MCAL/GPIO/GPIO_REG.h" 1
# 11 "HAL/LCD/../../MCAL/GPIO/GPIO_Interface.h" 2
...
void LCD4Bit_voidLCD_Init(LCD_4_BIT_T *Copy_stLCD4Bit) {
    ...
    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->LCD_RW.Port, Copy_stLCD4Bit->LCD_RW.Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->LCD_RS.Port, Copy_stLCD4Bit->LCD_RS.Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->LCD_EN.Port, Copy_stLCD4Bit->LCD_EN.Pin, 0);

    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->DataPin[0].Port, Copy_stLCD4Bit->DataPin[0].Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->DataPin[1].Port, Copy_stLCD4Bit->DataPin[1].Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->DataPin[2].Port, Copy_stLCD4Bit->DataPin[2].Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD4Bit->DataPin[3].Port, Copy_stLCD4Bit->DataPin[3].Pin, 0);


    _delay((unsigned long)((20)*(8000000/4000.0)));
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x38);
    _delay((unsigned long)((10)*(8000000/4000.0)));
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x38);
    _delay((unsigned long)((150)*(8000000/4000000.0)));
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x38);
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x01);
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x02);
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x06);
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x0C);
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x28);
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, 0x80);
}


void LCD4Bit_voidSendCommand(LCD_4_BIT_T *Copy_stLCD4Bit, u8 Copy_u8Command) {
    GPIO_VoidSetPinMode(Copy_stLCD4Bit->LCD_RS.Port, Copy_stLCD4Bit->LCD_RS.Pin, 0);
...
void LCD4Bit_voidSendChar(LCD_4_BIT_T *Copy_stLCD4Bit, u8 Copy_u8Char) {
    GPIO_VoidSetPinMode(Copy_stLCD4Bit->LCD_RS.Port, Copy_stLCD4Bit->LCD_RS.Pin, 1);
...
void LCD8Bit_voidLCD_Init(LCD_8_BIT_T *Copy_stLCD8Bit) {
    ...
    GPIO_VoidSetPinDirection(Copy_stLCD8Bit->LCD_RW.Port, Copy_stLCD8Bit->LCD_RW.Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD8Bit->LCD_RS.Port, Copy_stLCD8Bit->LCD_RS.Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stLCD8Bit->LCD_EN.Port, Copy_stLCD8Bit->LCD_EN.Pin, 0);
    for (u8 i = 0; i < 8; i++) {
        GPIO_VoidSetPinDirection(Copy_stLCD8Bit->DataPin[i].Port, Copy_stLCD8Bit->DataPin[i].Pin, 0);
    }

    _delay((unsigned long)((15)*(8000000/4000.0)));
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x38);
    _delay((unsigned long)((10)*(8000000/4000.0)));
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x38);
    _delay((unsigned long)((150)*(8000000/4000000.0)));
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x38);
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x08);
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x01);
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x02);
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x06);
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x0D);
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, 0x38);
}


void LCD8Bit_voidSendCommand(LCD_8_BIT_T *Copy_stLCD8Bit, u8 Copy_u8Command) {
    GPIO_VoidSetPinMode(Copy_stLCD8Bit->LCD_RS.Port, Copy_stLCD8Bit->LCD_RS.Pin, 0);
    for (u8 i = 0; i < 8; i++) {
...
void LCD8Bit_voidSendChar(LCD_8_BIT_T *Copy_stLCD8Bit, u8 Copy_u8Char) {
    ...
    GPIO_VoidSetPinMode(Copy_stLCD8Bit->LCD_RS.Port, Copy_stLCD8Bit->LCD_RS.Pin, 1);
    for (u8 i = 0; i < 8; i++) {
...
static void LCD_voidSendEnable_4Bit(LCD_4_BIT_T *Copy_stLCD4Bit) {
    GPIO_VoidSetPinMode(Copy_stLCD4Bit->LCD_EN.Port, Copy_stLCD4Bit->LCD_EN.Pin, 1);
    _delay((unsigned long)((10)*(8000000/4000000.0)));
    GPIO_VoidSetPinMode(Copy_stLCD4Bit->LCD_EN.Port, Copy_stLCD4Bit->LCD_EN.Pin, 0);
    _delay((unsigned long)((10)*(8000000/4000000.0)));
}

static void LCD_voidSendEnable_8Bit(LCD_8_BIT_T *Copy_stLCD8Bit) {
    GPIO_VoidSetPinMode(Copy_stLCD8Bit->LCD_EN.Port, Copy_stLCD8Bit->LCD_EN.Pin, 1);
    _delay((unsigned long)((10)*(8000000/4000000.0)));
    GPIO_VoidSetPinMode(Copy_stLCD8Bit->LCD_EN.Port, Copy_stLCD8Bit->LCD_EN.Pin, 0);
}
...
void LCD8Bit_voidSendCustomChar(LCD_8_BIT_T *Copy_stLCD8Bit, u8 Copy_u8Row, u8 Copy_u8Coulmn, u8 Copy_Au8Characters[], u8 Copy_u8MemPos) {
    LCD8Bit_voidSendCommand(Copy_stLCD8Bit, (0x40 + (Copy_u8MemPos)*40));
    for (u8 i = 0; i <= 7; i++) {
...
void LCD4Bit_voidSendCustomChar(LCD_4_BIT_T *Copy_stLCD4Bit, u8 Copy_u8Row, u8 Copy_u8Coulmn, u8 Copy_Au8Characters[], u8 Copy_u8MemPos) {
    LCD4Bit_voidSendCommand(Copy_stLCD4Bit, (0x40 + (Copy_u8MemPos)*40));
    for (u8 i = 0; i <= 7; i++) {
