...
# 2 "<built-in>" 2
# 1 "HAL/KeyPad/KEYPAD_program.c" 2
# 1 "HAL/KeyPad/../../LIB/BITMATH.h" 1
# 1 "HAL/KeyPad/KEYPAD_program.c" 2

# 1 "HAL/KeyPad/../../LIB/STDTYPES.h" 1
# 11 "HAL/KeyPad/../../LIB/STDTYPES.h"
...
# 11 "HAL/KeyPad/../../LIB/STDTYPES.h" 2
...
# 2 "HAL/KeyPad/KEYPAD_program.c" 2

# 1 "HAL/KeyPad/../../MCAL/GPIO/GPIO_Interface.h" 1
# 11 "HAL/KeyPad/../../MCAL/GPIO/GPIO_Interface.h"
# 1 "HAL/KeyPad/../../MCAL/GPIO/GPIO_REG.h" 1
# 11 "HAL/KeyPad/../../MCAL/GPIO/GPIO_Interface.h" 2
...
# 3 "HAL/KeyPad/KEYPAD_program.c" 2
...
# 4 "HAL/KeyPad/KEYPAD_program.c" 2
...
void KEYPAD_voidKeyPadInt(KeyPad_T *Copy_stKeyPad)
{
    for (u8 i = 0; i < 4; i++)
    {
        GPIO_VoidSetPinDirection(Copy_stKeyPad->RowPinConfig[i].Port, Copy_stKeyPad->RowPinConfig[i].Pin, 0);
    }
    for (u8 i = 0; i < 4; i++)
    {
        GPIO_VoidSetPinDirection(Copy_stKeyPad->CoulmPinConfig[i].Port, Copy_stKeyPad->CoulmPinConfig[i].Pin, 1);
    }
}
u8 KEYPAD_u8KeyPadPressed(KeyPad_T *Copy_stKeyPad)
{
    ...
    for (u8 i = 0; i < 4; i++)
    {
        ...
        for (u8 q = 0; q < 4; q++)
        {
            ...
            GPIO_VoidSetPinMode(Copy_stKeyPad->RowPinConfig[q].Port, Copy_stKeyPad->RowPinConfig[q].Pin, 0);
        }
        GPIO_VoidSetPinMode(Copy_stKeyPad->RowPinConfig[i].Port, Copy_stKeyPad->RowPinConfig[i].Pin, 1);
