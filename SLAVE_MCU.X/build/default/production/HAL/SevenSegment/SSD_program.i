# 1 "HAL/SevenSegment/SSD_program.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HAL/SevenSegment/SSD_program.c" 2
# 1 "HAL/SevenSegment/../../MCAL/GPIO/GPIO_Interface.h" 1
# 10 "HAL/SevenSegment/../../MCAL/GPIO/GPIO_Interface.h"
# 1 "HAL/SevenSegment/../../MCAL/GPIO/../../LIB/STDTYPES.h" 1
# 11 "HAL/SevenSegment/../../MCAL/GPIO/../../LIB/STDTYPES.h"
...
# 11 "HAL/SevenSegment/../../MCAL/GPIO/../../LIB/STDTYPES.h" 2
...
# 10 "HAL/SevenSegment/../../MCAL/GPIO/GPIO_Interface.h" 2

# 1 "HAL/SevenSegment/../../MCAL/GPIO/GPIO_REG.h" 1
# 11 "HAL/SevenSegment/../../MCAL/GPIO/GPIO_Interface.h" 2
...
# 1 "HAL/SevenSegment/SSD_config.h" 1
# 2 "HAL/SevenSegment/SSD_program.c" 2

# 1 "HAL/SevenSegment/SSD_interface.h" 1
# 10 "HAL/SevenSegment/SSD_interface.h"
# 1 "HAL/SevenSegment/../../LIB/BITMATH.h" 1
# 10 "HAL/SevenSegment/SSD_interface.h" 2
# 37 "HAL/SevenSegment/SSD_interface.h"
typedef struct
{
    u8 Port;
    u8 Pin ;
...
# 3 "HAL/SevenSegment/SSD_program.c" 2
# 38 "HAL/SevenSegment/SSD_program.c"
void SSD_voidSSD_BCDInt(SSD_T *Copy_stSSD)
{
    GPIO_VoidSetPinDirection(Copy_stSSD->PinConfig[0].Port, Copy_stSSD->PinConfig[0].Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stSSD->PinConfig[1].Port, Copy_stSSD->PinConfig[1].Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stSSD->PinConfig[2].Port, Copy_stSSD->PinConfig[2].Pin, 0);
    GPIO_VoidSetPinDirection(Copy_stSSD->PinConfig[3].Port, Copy_stSSD->PinConfig[3].Pin, 0);
}
void SSD_voidSSD_BCDWriteNumber(SSD_T *Copy_stSSD, u8 Copy_u8SSDNumber)
{
