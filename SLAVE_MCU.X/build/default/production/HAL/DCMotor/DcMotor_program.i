# 1 "HAL/DCMotor/DcMotor_program.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HAL/DCMotor/DcMotor_program.c" 2
# 1 "HAL/DCMotor/../../LIB/BITMATH.h" 1
# 1 "HAL/DCMotor/DcMotor_program.c" 2

# 1 "HAL/DCMotor/../../LIB/STDTYPES.h" 1
# 11 "HAL/DCMotor/../../LIB/STDTYPES.h"
...
# 11 "HAL/DCMotor/../../LIB/STDTYPES.h" 2
...
# 2 "HAL/DCMotor/DcMotor_program.c" 2

# 1 "HAL/DCMotor/../../MCAL/GPIO/GPIO_Interface.h" 1
# 11 "HAL/DCMotor/../../MCAL/GPIO/GPIO_Interface.h"
# 1 "HAL/DCMotor/../../MCAL/GPIO/GPIO_REG.h" 1
# 11 "HAL/DCMotor/../../MCAL/GPIO/GPIO_Interface.h" 2
...
# 3 "HAL/DCMotor/DcMotor_program.c" 2

# 1 "HAL/DCMotor/DCMotor_interface.h" 1
# 13 "HAL/DCMotor/DCMotor_interface.h"
# 1 "HAL/DCMotor/../../MCAL/CCP/CCP.h" 1




# 1 "HAL/DCMotor/../../MCAL/CCP/../../LIB/pic18f4620.h" 1
# 5 "HAL/DCMotor/../../MCAL/CCP/CCP.h" 2




# 1 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_interface.h" 1
# 12 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_interface.h"
# 1 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_config.h" 1
# 14 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_config.h"
# 1 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_generation_config.h" 1
# 14 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_config.h" 2
# 12 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_interface.h" 2
# 78 "HAL/DCMotor/../../MCAL/CCP/../Interrupt/Interrupt_interface.h"
typedef enum {
...
# 9 "HAL/DCMotor/../../MCAL/CCP/CCP.h" 2

# 1 "HAL/DCMotor/../../MCAL/CCP/CCP_Config.h" 1
# 10 "HAL/DCMotor/../../MCAL/CCP/CCP.h" 2
# 79 "HAL/DCMotor/../../MCAL/CCP/CCP.h"
typedef union
{
    struct
    {
...
# 126 "HAL/DCMotor/../../MCAL/CCP/CCP.h"
} CCP_t;
...
# 13 "HAL/DCMotor/DCMotor_interface.h" 2
...
# 4 "HAL/DCMotor/DcMotor_program.c" 2

# 1 "HAL/DCMotor/../../MCAL/TIMER2/TIMER2.h" 1



# 1 "HAL/DCMotor/../../MCAL/TIMER2/../../LIB/pic18f4620.h" 1
# 4 "HAL/DCMotor/../../MCAL/TIMER2/TIMER2.h" 2



# 1 "HAL/DCMotor/../../MCAL/TIMER2/../../LIB/device_config.h" 1
# 17 "HAL/DCMotor/../../MCAL/TIMER2/../../LIB/device_config.h"
...
# 7 "HAL/DCMotor/../../MCAL/TIMER2/TIMER2.h" 2
# 56 "HAL/DCMotor/../../MCAL/TIMER2/TIMER2.h"
typedef struct {
    u8 prescaler;
    u8 postscaler;
    u8 preload;
...
# 5 "HAL/DCMotor/DcMotor_program.c" 2
# 17 "HAL/DCMotor/DcMotor_program.c"
timer2_t t2 = {
    .postscaler = 0,
    .prescaler = 0,
    .preload = 0
...
void DCMOTOR_voidDcMotorInt(DcMotor_T *Copy_stDcMotor) {
    GPIO_VoidSetPinDirection(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[0], 0);
    GPIO_VoidSetPinDirection(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[1], 0);
# 41 "HAL/DCMotor/DcMotor_program.c"
    ...
    GPIO_VoidSetPinMode(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[0], 0);
    GPIO_VoidSetPinMode(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[1], 0);
}
...
void DCMOTOR_voidDcMotoroTurnForward(DcMotor_T *Copy_stDcMotor, u8 Copy_u8Speed) {
    GPIO_VoidSetPinMode(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[0], 1);
    GPIO_VoidSetPinMode(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[1], 0);
...
void DCMOTOR_voidDcMotoroTurnReverse(DcMotor_T *Copy_stDcMotor, u8 Copy_u8Speed) {
    GPIO_VoidSetPinMode(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[1], 1);
    GPIO_VoidSetPinMode(Copy_stDcMotor->Port, Copy_stDcMotor->Pin[0], 0);
