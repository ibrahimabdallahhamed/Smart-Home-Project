...
# 2 "<built-in>" 2
# 1 "HAL/LED/LED_program.c" 2
# 1 "HAL/LED/../../MCAL/GPIO/GPIO_Interface.h" 1
# 10 "HAL/LED/../../MCAL/GPIO/GPIO_Interface.h"
# 1 "HAL/LED/../../MCAL/GPIO/../../LIB/STDTYPES.h" 1
# 11 "HAL/LED/../../MCAL/GPIO/../../LIB/STDTYPES.h"
...
# 11 "HAL/LED/../../MCAL/GPIO/../../LIB/STDTYPES.h" 2
...
# 10 "HAL/LED/../../MCAL/GPIO/GPIO_Interface.h" 2

# 1 "HAL/LED/../../MCAL/GPIO/GPIO_REG.h" 1
# 11 "HAL/LED/../../MCAL/GPIO/GPIO_Interface.h" 2
...
# 12 "HAL/LED/LED_interface.h"
# 1 "HAL/LED/../../LIB/BITMATH.h" 1
# 12 "HAL/LED/LED_interface.h" 2
...
# 2 "HAL/LED/LED_program.c" 2


void LED_voidLedInt(LED_T *Copy_stLed) {
    GPIO_VoidSetPinDirection(Copy_stLed->Port, Copy_stLed->Pin, 0);
    switch (Copy_stLed->Stauts) {
        case 1:
            GPIO_VoidSetPinMode(Copy_stLed->Port, Copy_stLed->Pin, 1);
            break;

        case 0:
            GPIO_VoidSetPinMode(Copy_stLed->Port, Copy_stLed->Pin, 0);
            break;
    }
}
