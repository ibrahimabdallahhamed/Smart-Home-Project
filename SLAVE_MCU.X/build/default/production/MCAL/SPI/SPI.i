...
# 1104 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1216 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1328 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1380 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1495 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned TRISA0 :1;
        unsigned TRISA1 :1;
...
# 1602 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1717 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned TRISB0 :1;
        unsigned TRISB1 :1;
...
# 1824 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1939 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned TRISC0 :1;
        unsigned TRISC1 :1;
...
# 2046 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2161 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned TRISD0 :1;
        unsigned TRISD1 :1;
...
# 2268 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2354 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned TRISE0 :1;
        unsigned TRISE1 :1;
...
# 2432 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2497 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2574 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2651 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2728 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2794 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2860 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2926 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 2992 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3129 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned RX9D :1;
        unsigned OERR :1;
...
# 3230 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3362 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned TX9D :1;
        unsigned TRMT :1;
...
# 3486 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3641 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3752 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3831 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3913 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 3983 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4073 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned ABDEN :1;
        unsigned WUE :1;
...
# 4155 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4234 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4352 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4444 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4529 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4648 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4731 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 4801 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5022 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5107 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5166 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned :7;
        unsigned EBDIS :1;
...
# 5217 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5327 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5481 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5509 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5648 "MCAL/SPI/../../LIB/pic18f4620.h"
typedef union {
    struct {
        unsigned HLVDL :4;
        unsigned HLVDEN :1;
...
# 5779 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5856 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 5933 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6025 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6156 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6304 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6374 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6491 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6691 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 6730 "MCAL/SPI/../../LIB/pic18f4620.h"
...
# 1 "MCAL/SPI/../../LIB/device_config.h" 1
...
# 1 "MCAL/SPI/../../LIB/STDTYPES.h" 1
# 11 "MCAL/SPI/../../LIB/STDTYPES.h"
...
# 1 "MCAL/SPI/../../LIB/BITMATH.h" 1
# 7 "MCAL/SPI/SPI.h" 2

# 1 "MCAL/SPI/../GPIO/GPIO_Interface.h" 1
# 11 "MCAL/SPI/../GPIO/GPIO_Interface.h"
# 1 "MCAL/SPI/../GPIO/GPIO_REG.h" 1
# 11 "MCAL/SPI/../GPIO/GPIO_Interface.h" 2
...
# 1 "MCAL/SPI/../Interrupt/Interrupt_interface.h" 1
# 12 "MCAL/SPI/../Interrupt/Interrupt_interface.h"
# 1 "MCAL/SPI/../Interrupt/Interrupt_config.h" 1
# 11 "MCAL/SPI/../Interrupt/Interrupt_config.h"
# 1 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\proc\\pic18f4620.h" 1 3
# 11 "MCAL/SPI/../Interrupt/Interrupt_config.h" 2



# 1 "MCAL/SPI/../Interrupt/Interrupt_generation_config.h" 1
# 14 "MCAL/SPI/../Interrupt/Interrupt_config.h" 2
# 12 "MCAL/SPI/../Interrupt/Interrupt_interface.h" 2
# 78 "MCAL/SPI/../Interrupt/Interrupt_interface.h"
typedef enum {
...
void (*SPI_INTERRUPT_HANDELER)(void) = ((void*)0);

void SPI_voidSPI_Init(spi_t *Copy_stSPI)
{
    if (((void*)0) != Copy_stSPI)
    {
...
static void SPI_ModeConfig(spi_t *Copy_stSPI)
{
    if (((void*)0) != Copy_stSPI)
    {
        (SSPCON1bits.SSPM = Copy_stSPI->spi_mode);
        if ((0 == Copy_stSPI->spi_mode) ||
            (1 == Copy_stSPI->spi_mode) ||
            (2 == Copy_stSPI->spi_mode) ||
            (3 == Copy_stSPI->spi_mode))
        {
            GPIO_VoidSetPinDirection(2, 5, 0);
            GPIO_VoidSetPinDirection(2, 4, 1);
            GPIO_VoidSetPinDirection(2, 3, 0);
        }
        else if (5 == Copy_stSPI->spi_mode)
        {
            GPIO_VoidSetPinDirection(2, 5, 0);
            GPIO_VoidSetPinDirection(2, 4, 1);
            GPIO_VoidSetPinDirection(2, 3, 1);
        }
        else if (4 == Copy_stSPI->spi_mode)
        {
            GPIO_VoidSetPinDirection(2, 5, 0);
            GPIO_VoidSetPinDirection(2, 4, 1);
            GPIO_VoidSetPinDirection(2, 3, 1);
            GPIO_VoidSetPinDirection(0, 5, 1);
        }
    }
}
static void SPI_SampleConfig(spi_t *Copy_stSPI)
