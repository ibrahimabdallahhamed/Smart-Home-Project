...
# 1 "MCAL/ADC/../../LIB/STDTYPES.h" 1
# 11 "MCAL/ADC/../../LIB/STDTYPES.h"
...
# 13 "MCAL/ADC/ADC_config.h" 2

# 1 "MCAL/ADC/../../LIB/BITMATH.h" 1
# 14 "MCAL/ADC/ADC_config.h" 2

# 1 "MCAL/ADC/../GPIO/GPIO_Interface.h" 1
# 11 "MCAL/ADC/../GPIO/GPIO_Interface.h"
# 1 "MCAL/ADC/../GPIO/GPIO_REG.h" 1
# 11 "MCAL/ADC/../GPIO/GPIO_Interface.h" 2
...
# 15 "MCAL/ADC/ADC_config.h" 2

# 1 "MCAL/ADC/../Interrupt/Interrupt_interface.h" 1
# 12 "MCAL/ADC/../Interrupt/Interrupt_interface.h"
# 1 "MCAL/ADC/../Interrupt/Interrupt_config.h" 1
# 14 "MCAL/ADC/../Interrupt/Interrupt_config.h"
# 1 "MCAL/ADC/../Interrupt/Interrupt_generation_config.h" 1
# 14 "MCAL/ADC/../Interrupt/Interrupt_config.h" 2
# 12 "MCAL/ADC/../Interrupt/Interrupt_interface.h" 2
# 78 "MCAL/ADC/../Interrupt/Interrupt_interface.h"
typedef enum {
...
u16 ADC_u16GetConversionResult(ADC_congig_t *Copy_stADC) {
    if (0x01 == Copy_stADC->ResultFormat) {
...
static void ADC_ChannelConfig(ADC_Channel_Select_t channel) {
    ...
    switch (channel) {
        case ADC_CHANNEL_AN0:
            GPIO_VoidSetPinDirection(PORTA, 0, 1);
            break;
        case ADC_CHANNEL_AN1:
            GPIO_VoidSetPinDirection(PORTA, 1, 1);
            break;
        case ADC_CHANNEL_AN2:
            GPIO_VoidSetPinDirection(PORTA, 2, 1);
            break;
        case ADC_CHANNEL_AN3:
            GPIO_VoidSetPinDirection(PORTA, 3, 1);
            break;
        case ADC_CHANNEL_AN4:
            GPIO_VoidSetPinDirection(PORTA, 5, 1);
        case ADC_CHANNEL_AN5:
            GPIO_VoidSetPinDirection(PORTE, 0, 1);
            break;
        case ADC_CHANNEL_AN6:
            GPIO_VoidSetPinDirection(PORTE, 1, 1);
            break;
        case ADC_CHANNEL_AN7:
            GPIO_VoidSetPinDirection(PORTE, 2, 1);
            break;
        case ADC_CHANNEL_AN8:
            GPIO_VoidSetPinDirection(PORTB, 2, 1);
            break;
        case ADC_CHANNEL_AN9:
            GPIO_VoidSetPinDirection(PORTB, 3, 1);
            break;
        case ADC_CHANNEL_AN10:
            GPIO_VoidSetPinDirection(PORTB, 1, 1);
            break;
        case ADC_CHANNEL_AN11:
            GPIO_VoidSetPinDirection(PORTB, 4, 1);
            break;
        case ADC_CHANNEL_AN12:
            GPIO_VoidSetPinDirection(PORTB, 0, 1);
            break;
    }
}
